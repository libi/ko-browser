...
func TestTab_List_AllTabs(t *testing.T) {
	b := newBrowser(t)
...
func TestTab_Switch_VerifyActive(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
	must(t, b.TabNew(testdataURL("phase2_nav_a.html")))
	time.Sleep(500 * time.Millisecond)
...
func TestTab_Close_MiddleTab(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
	must(t, b.TabNew(testdataURL("phase2_nav_a.html")))
	time.Sleep(500 * time.Millisecond)
...
func TestTab_Close_CurrentTab(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
	must(t, b.TabNew(testdataURL("phase2_nav_a.html")))
	time.Sleep(500 * time.Millisecond)
...
func TestTab_Close_OnlyTabFails(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
	err := b.TabClose(0)
	if err == nil {
...
func TestTab_Switch_OutOfRange(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
	err := b.TabSwitch(5)
	if err == nil {
...
func TestTab_Close_OutOfRange(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
...
func TestTab_New_BlankTab(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
	must(t, b.TabNew(""))
	time.Sleep(300 * time.Millisecond)
...
func TestTab_Operations_AfterSwitch(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
	must(t, b.TabNew(testdataURL("phase2_nav_a.html")))
	time.Sleep(500 * time.Millisecond)
...
func TestTab_JS_WindowOpen(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
	tabs1, err := b.TabList()
	must(t, err)
...
func TestTab_Format_List(t *testing.T) {
...
func TestFind_Role_Exact(t *testing.T) {
	b := newBrowser(t)
...
func TestFind_Text_Exact(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase3_screenshot.html")
	_ = mustSnapshot(t, b)
...
func TestFind_Label_Exact(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase3_screenshot.html")
	_ = mustSnapshot(t, b)
...
func TestNetwork_StartLogging_Requests(t *testing.T) {
	b := newBrowser(t)
...
func TestNetwork_Route_Unroute(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
...
func TestNetwork_Clear_Requests(t *testing.T) {
	b := newBrowser(t)
	must(t, b.NetworkStartLogging())
	openPage(t, b, "phase5_test.html")
...
func TestConsole_Filter_Level(t *testing.T) {
	b := newBrowser(t)
...
func TestPageErrors_Clear_List(t *testing.T) {
	b := newBrowser(t)
	must(t, b.ConsoleStart())
	openPage(t, b, "phase6_test.html")
...
func TestSettings_SetViewport_WithScale(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase6_test.html")
...
func TestSettings_ClearGeo(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase6_test.html")
...
func TestSettings_SetDevice_Unknown_Coverage(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase6_test.html")
...
func TestClipboard_Write_Read(t *testing.T) {
	b := newBrowser(t)
...
func TestDiff_Snapshot_NoPreviousError_Coverage(t *testing.T) {
	b := newBrowser(t)
...
func TestDiff_Screenshot_NoBaseline_Coverage(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
...
func TestState_Import_Nonexistent(t *testing.T) {
	b := newBrowser(t)
...
func TestGet_CDPURL_Value(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	url, err := b.GetCDPURL()
	must(t, err)
...
func TestEval_Return_Null(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestEval_Return_Object(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestEval_Return_Array(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestEval_Return_Boolean(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestGet_Text_InvalidID(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	_ = mustSnapshot(t, b)
...
func TestStorage_SessionStorage_GetAll(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
...
func TestStorage_Clear_Session(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
...
func TestSnapshot_Selector_Option(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestSnapshot_Cursor_Option(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestScreenshot_Element_ByID(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase3_screenshot.html")
	snap := mustSnapshot(t, b)
...
func TestWait_Hidden_Nonexistent(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	must(t, b.WaitHidden("#nonexistent-element"))
}

func TestWait_URL_Pattern(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestSettings_SetMedia_MultipleFeatures(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase6_test.html")
	must(t, b.SetMedia(
