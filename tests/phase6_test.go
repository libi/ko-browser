...
func TestPhase6_SetViewport(t *testing.T) {
	b := newBrowser(t)
...
func TestPhase6_SetDevice(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase6_test.html")
...
func TestPhase6_SetDeviceUnknown(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase6_test.html")
...
func TestPhase6_SetGeo(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase6_test.html")
...
func TestPhase6_SetOffline(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase6_test.html")
...
func TestPhase6_SetHeaders(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase6_test.html")
...
func TestPhase6_SetColorScheme(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase6_test.html")
...
func TestPhase6_SetMedia(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase6_test.html")
...
func TestPhase6_ConsoleMessages(t *testing.T) {
	b := newBrowser(t)
...
func TestPhase6_ConsoleMessagesByLevel(t *testing.T) {
	b := newBrowser(t)
	if err := b.ConsoleStart(); err != nil {
		t.Fatalf("ConsoleStart: %v", err)
	}
...
func TestPhase6_ConsoleClear(t *testing.T) {
	b := newBrowser(t)
	if err := b.ConsoleStart(); err != nil {
		t.Fatalf("ConsoleStart: %v", err)
	}
...
func TestPhase6_PageErrors(t *testing.T) {
	b := newBrowser(t)
	if err := b.ConsoleStart(); err != nil {
		t.Fatalf("ConsoleStart: %v", err)
	}
...
func TestPhase6_Highlight(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase6_test.html")
...
func TestPhase6_SetCredentials(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase6_test.html")
