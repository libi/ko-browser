...
// =============================================================================
// Unit tests without launching a browser
// =============================================================================

// TestCLI_Auth_Vault tests the auth vault CRUD operations.
func TestCLI_Auth_Vault(t *testing.T) {
	home := t.TempDir()
	t.Setenv("HOME", home)
...
// TestCLI_Confirm_Store tests the confirmation store mechanism.
func TestCLI_Confirm_Store(t *testing.T) {
...
// TestCLI_Install_FindChrome verifies Chrome is available (required by all tests).
func TestCLI_Install_FindChrome(t *testing.T) {
	b := newBrowser(t)
	_ = b
}
...
func TestCLI_Keyboard_Type(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	snap := mustSnapshot(t, b)
	nameID := findID(t, snap.Text, `textbox "Name"`)
...
func TestCLI_Keyboard_InsertText(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	snap := mustSnapshot(t, b)
	nameID := findID(t, snap.Text, `textbox "Name"`)
...
func TestCLI_Scroll_IntoView(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	snap := mustSnapshot(t, b)
	btnID := findID(t, snap.Text, `button "Submit"`)
...
func TestCLI_Get_Title(t *testing.T) {
	b := newBrowser(t)
...
func TestCLI_Get_URL(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase2_query.html")
	url, err := b.GetURL()
	must(t, err)
...
func TestCLI_Get_Text(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase2_query.html")
	snap := mustSnapshot(t, b)
...
func TestCLI_Get_HTML(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase2_query.html")
	snap := mustSnapshot(t, b)
	id := findAnyID(t, snap.Text)
...
func TestCLI_Get_Value(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	snap := mustSnapshot(t, b)
	nameID := findID(t, snap.Text, `textbox "Name"`)
...
func TestCLI_Get_Attr(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase2_query.html")
	snap := mustSnapshot(t, b)
...
func TestCLI_Get_Count(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestCLI_Get_Box(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	snap := mustSnapshot(t, b)
	nameID := findID(t, snap.Text, `textbox "Name"`)
...
func TestCLI_Get_Styles(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	snap := mustSnapshot(t, b)
	nameID := findID(t, snap.Text, `textbox "Name"`)
...
func TestCLI_Is_Visible(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	snap := mustSnapshot(t, b)
	nameID := findID(t, snap.Text, `textbox "Name"`)
...
func TestCLI_Is_Enabled(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	snap := mustSnapshot(t, b)
	nameID := findID(t, snap.Text, `textbox "Name"`)
...
func TestCLI_Is_Checked(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	snap := mustSnapshot(t, b)
	termsID := findID(t, snap.Text, `checkbox "Terms"`)
...
func TestCLI_Wait_Time(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	start := time.Now()
...
func TestCLI_Wait_Selector(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	must(t, b.WaitSelector("input"))
}

func TestCLI_Wait_URL(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	must(t, b.WaitURL("*interaction*"))
}

func TestCLI_Wait_Load(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	must(t, b.WaitLoad())
}

func TestCLI_Wait_Text(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	must(t, b.WaitText("Submit"))
}

func TestCLI_Wait_Func(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	must(t, b.WaitFunc("document.readyState === 'complete'"))
}

func TestCLI_Wait_Hidden(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestCLI_Find_Role(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	_ = mustSnapshot(t, b)
...
func TestCLI_Find_Text(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	_ = mustSnapshot(t, b)
...
func TestCLI_Find_Label(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	_ = mustSnapshot(t, b)
...
func TestCLI_Find_Nth(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	_ = mustSnapshot(t, b)
...
func TestCLI_Find_Last(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	_ = mustSnapshot(t, b)
...
func TestCLI_Find_Placeholder(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	_ = mustSnapshot(t, b)
...
func TestCLI_Find_TestID(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	_ = mustSnapshot(t, b)
	// May or may not find a match; just verify the method works
...
func TestCLI_Snapshot_Options(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestCLI_Mouse_Operations(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestCLI_Tab_Operations(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	tabs, err := b.TabList()
	must(t, err)
...
func TestCLI_Cookie_Operations(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestCLI_Storage_Operations(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestCLI_SetViewport_WithScale(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestCLI_Console_Messages(t *testing.T) {
	b := newBrowser(t)
...
func TestCLI_PageErrors_List(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestCLI_Clipboard_ReadWrite(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestCLI_Clipboard_CopyPaste(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	snap := mustSnapshot(t, b)
	nameID := findID(t, snap.Text, `textbox "Name"`)
...
func TestCLI_Network_Operations(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestCLI_Diff_Snapshot(t *testing.T) {
	b := newBrowser(t)
...
func TestCLI_Trace_StartStop(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	must(t, b.TraceStart())
	time.Sleep(200 * time.Millisecond)
...
func TestCLI_Profiler_StartStop(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestCLI_Record_StartStop(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	dir := t.TempDir()
...
func TestCLI_State_ExportImport(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestCLI_Get_CDPURL(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	url, err := b.GetCDPURL()
	must(t, err)
...
func TestCLI_Session_List(t *testing.T) {
...
func TestCLI_Find_First(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	_ = mustSnapshot(t, b)
...
func TestCLI_Find_Alt(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	_ = mustSnapshot(t, b)
...
func TestCLI_Find_Title(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	_ = mustSnapshot(t, b)
	// May or may not match; just verify no panic
...
func TestCLI_Diff_Screenshot(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
...
func TestCLI_Diff_URL(t *testing.T) {
	b := newBrowser(t)
...
func TestCLI_Console_Clear(t *testing.T) {
	b := newBrowser(t)
	must(t, b.ConsoleStart())
	openPage(t, b, "phase1_interaction.html")
	b.ConsoleClear()
...
func TestCLI_PageErrors_Clear(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	b.PageErrorsClear()
	errs, err := b.PageErrors()
...
func TestCLI_SetGeo_Clear(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase1_interaction.html")
	must(t, b.SetGeo(37.7749, -122.4194))
	must(t, b.ClearGeo())
