...
func TestPhase7_DiffSnapshot_PreviousSnapshot(t *testing.T) {
	b := newBrowser(t)
...
func TestPhase7_DiffSnapshot_BaselineFile(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
...
func TestPhase7_DiffSnapshot_NoPreviousError(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
...
func TestPhase7_DiffSnapshot_NoChange(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
...
func TestPhase7_DiffScreenshot_Basic(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
...
func TestPhase7_DiffScreenshot_WithChange(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
...
func TestPhase7_DiffScreenshot_NoBaseline(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
...
func TestPhase7_DiffURL_DifferentPages(t *testing.T) {
	b := newBrowser(t)
...
func TestPhase7_DiffURL_SamePage(t *testing.T) {
	b := newBrowser(t)
...
func TestPhase7_DiffURL_WithScreenshot(t *testing.T) {
	b := newBrowser(t)
...
func TestPhase7_TraceStartStop(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
...
func TestPhase7_TraceDoubleStart(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
...
func TestPhase7_TraceStopWithoutStart(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
...
func TestPhase7_ProfilerStartStop(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
...
func TestPhase7_ProfilerDoubleStart(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
...
func TestPhase7_ProfilerStopWithoutStart(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
...
func TestPhase7_RecordStartStop(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
	time.Sleep(500 * time.Millisecond)
...
func TestPhase7_RecordDoubleStart(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
...
func TestPhase7_RecordStopWithoutStart(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
...
func TestPhase7_ExportImportState(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
	time.Sleep(300 * time.Millisecond)
...
func TestPhase7_ExportState_EmptyPage(t *testing.T) {
	b := newBrowser(t)
...
func TestPhase7_ImportState_NonExistentFile(t *testing.T) {
	b := newBrowser(t)
...
func TestPhase7_ProfileOption(t *testing.T) {
	tmpDir := t.TempDir()
...
func TestPhase7_ConfigFileFormat(t *testing.T) {
...
func TestPhase7_ApplyState(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
...
func TestPhase7_TraceWithDiff(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase7_test.html")
