...
func TestPhase5_TabList(t *testing.T) {
	b := newBrowser(t)
...
func TestPhase5_TabNew(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
...
func TestPhase5_TabSwitch(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
...
func TestPhase5_TabClose(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
...
func TestPhase5_CookiesSetAndGet(t *testing.T) {
	b := newBrowser(t)
...
func TestPhase5_CookieDelete(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
...
func TestPhase5_CookiesClear(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
...
func TestPhase5_StorageSetAndGet(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
...
func TestPhase5_StorageGetPreset(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
...
func TestPhase5_SessionStorage(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
...
func TestPhase5_StorageDelete(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
...
func TestPhase5_StorageClear(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
...
func TestPhase5_StorageGetAll(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase5_test.html")
