...
func TestPhase4_Drag(t *testing.T) {
	b := newBrowser(t)
...
func TestPhase4_Upload(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase4_advanced.html")
...
func TestPhase4_MouseMove(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase4_advanced.html")
	mustSnapshot(t, b)
...
func TestPhase4_MouseDown_MouseUp(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase4_advanced.html")
	mustSnapshot(t, b)
...
func TestPhase4_MouseWheel(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase4_advanced.html")
	mustSnapshot(t, b)
...
func TestPhase4_MouseClick(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase4_advanced.html")
	mustSnapshot(t, b)
...
func TestPhase4_DragCoords(t *testing.T) {
	b := newBrowser(t)
	openPage(t, b, "phase4_advanced.html")
